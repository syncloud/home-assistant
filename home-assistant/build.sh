...
tar xf app.tar
rm -rf app.tar
sed -i '#import sys#a sys.executable = /snap/home-assistant/current/home-assistant/bin/python' ${BUILD_DIR}/home-assistant/usr/src/homeassistant/homeassistant/__main__.py
