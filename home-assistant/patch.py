...
otbr_config_flow = os.path.join(
    BUILD_DIR, "usr/src/homeassistant/homeassistant/components/otbr/config_flow.py"
)

patch(otbr_config_flow, [
    (
        ...
        "                vol.Required(\n"
        "                    CONF_URL,\n"
        "                    default=\"unix:///var/snap/home-assistant/current/otbr.socket\",\n"
        "                ): str\n"
        "            }\n"
        "        )",
    ),
